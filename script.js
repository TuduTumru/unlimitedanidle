...
document.getElementById("submitguess").onclick = function updatecounter(){
  if (document.getElementById("search").value.length > 0) {
    ...
    if (typeof globalsearchresult[0] === `undefined`){
      ...
      console.log("selected anime is",globalsearchresult[0])
      ...
      if (regex.test(submitted)){
        ...
        console.log("submitted anime's :",submitted)
...
fetch('Database/Database.csv') // Ensure the file is in the same directory or adjust the path
